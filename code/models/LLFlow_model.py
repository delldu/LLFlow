...
class LLFlowModel(BaseModel):
    def __init__(self, opt, step):
        ...
        # self.hr_size = opt['datasets']['train']['GT_size']  # -- 160
        # # opt_get(opt, ['datasets', 'train', 'center_crop_hr_size'])
        # # self.hr_size = 160 if self.hr_size is None else self.hr_size
        # self.lr_size = self.hr_size // opt['scale'] # ==> opt['scale'] -- 1
        ...
        # opt_get(self.opt, ['train', 'weight_l1']) -- 0
